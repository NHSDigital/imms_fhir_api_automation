...
SHARED_KEY = "BackBone"  # Note: Don't hard code your passwords in a real implementation.
...
# example usage
MAILBOX_ID = "X26OT302" # Note: Don't hard code your mailbox id in a real implementation.
MAILBOX_PASSWORD = "Vh45dfz2IKwG"  # Note: Don't hard code your passwords in a real implementation.
