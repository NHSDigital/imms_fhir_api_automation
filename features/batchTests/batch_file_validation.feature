...
Scenario Outline: verify that vaccination file will be rejected if file name format is invalid
    ...
    And Audit table will have failed status, <queue_name> and <error_details> for the processed batch file

    Examples:
        | invalidFilename           |  file_extension         |     queue_name         | error_details                                      |
        | HP_Vaccinations_v5_YGM41  | csv                     |unknown_unknown         | Initial file validation failed: invalid file key   |
        | HPV_Vaccinations_v5_YGM41 | pdf                     |unknown_unknown         | Initial file validation failed: invalid file key   |
        | HPV_Vaccination_v5_YGM41  | csv                     |unknown_unknown         | Initial file validation failed: invalid file key   |
        | HPV_Vaccinations_v0_YGM41 | csv                     |unknown_unknown         | Initial file validation failed: invalid file key   |
        | HPV_Vaccinations_v0_ABC12 | csv                     |unknown_unknown         | Initial file validation failed: invalid file key   |
